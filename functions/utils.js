...
const SUBCOLN_ASSISTANT_ACTIVITY = "activity";
const DOC_ASSISTANT_FCM_TOKEN = "client_token";
const DOC_AST_ACTIVE_REQUEST = "active_req";
const DOCFIELD_REQUEST_REF = "req_ref";
const DOCFIELD_TIMESTAMP = "timestamp";
//society subcoln
...
const REQUEST_STATUS_CHECK_TIMEOUT = 80000  //80 seconds
const TIMETABLE_SEARCH_BUFFER = 1200;   //20 mins
...
module.exports = {
    COLN_USERS,COLN_ASSISTANTS,COLN_REQUESTS,COLN_VISITS,COLN_TIMETABLE,COLN_SOCIETIES,COLN_ASSISTANT_ANALYTICS,SUBCOLN_ASSISTANT_ANALYTICS,SUBCOLN_ASSISTANT_ACTIVITY,SUBCOLN_ASSISTANT_FCM,
